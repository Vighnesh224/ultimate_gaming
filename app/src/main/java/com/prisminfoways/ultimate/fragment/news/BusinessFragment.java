...
import com.prisminfoways.ultimate.databinding.FragmentBusinessBinding;
...
public class BusinessFragment extends Fragment {
    ...
    String url = "http://netbywell.com/ci_news/news_list.php?type=business";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        businessBinding = DataBindingUtil.inflate(inflater, R.layout.fragment_business, container, false);
    ...
    private void loadWebView() {
        ...
        WebSettings webSettings = businessBinding.webView.getSettings();
        ...
        businessBinding.webView.setWebViewClient(new WebViewClient() {
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                ...
                startActivity(new Intent(activity, DetailActivity.class).putExtra("link", url));
                return true;
            }
        ...
        businessBinding.webView.loadUrl(url);
    }

    IUnityAdsListener adsListener = new IUnityAdsListener() {
        ...
        public void onUnityAdsFinish(String zoneId, UnityAds.FinishState result) {
            ...
            UnityAds.setListener(new IUnityAdsExtendedListener() {
                ...
                public void onUnityAdsPlacementStateChanged(String s, UnityAds.PlacementState placementState, UnityAds.PlacementState placementState1) {
                    Log.d(TAG,"placement state changed");
                }
...
//Unity Ads show failed: Placement "null" is not ready