...
import com.prisminfoways.ultimate.databinding.FragmentTechnologyBinding;
...
public class TechnologyFragment extends Fragment {
    ...
    Activity activity;
    String url = "http://netbywell.com/ci_news/news_list.php?type=technology";
    ...
    private void loadunity(String link) {

        if (!UnityAds.isInitialized()) {
            firsttimeloading = true;
            UnityAds.initialize(getActivity(), "3161787", adsListener, false);
        } else {
            if (UnityAds.isReady()) {
                customLoader.showLoader();
        ...
        public void onUnityAdsFinish(String zoneId, UnityAds.FinishState result) {
            ...
            UnityAds.setListener(new IUnityAdsExtendedListener() {
                ...
                public void onUnityAdsError(UnityAds.UnityAdsError unityAdsError, String s) {
                    Log.d(TAG, "onUnityAdsError: " + unityAdsError + ":" + s);
                    customLoader.dismissLoader();
                    startActivity(new Intent(activity, DetailActivity.class).putExtra("link", storeUserData.getString("link")));
                }
            });
